# plot "Tahoe1.plot" w l lw 2, "Reno1.plot" w l lw 2,"Newreno1.plot" w l lw 2,"Sack1.plot" w l lw 2 ,"Vegas1.plot" w l lw 2
...
set tracefile [open tahoe1.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open tahoe1.nam w]
...
#Setup a CBR Application over TCP/Tahoe connection
...
set tahoe1 [open "Tahoe1.plot" w]
$ns at 0.0 "plotWindow $tcp0 $tahoe1"
...
$ns at 0.5 "$ns trace-annotate \"Starting CBR1 node7 to node8\"" 
