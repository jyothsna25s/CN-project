...
set tracefile [open Aomdv22.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open Aomdv22.nam w]
...
proc finish {} {
    ...
    close $tracefile
    close $namfile
    exec nam Aomdv22.nam &
    exit 0
}
for {set i 0} {$i < $val(nn) } { incr i } {
    $ns at $val(stop) "\$n$i reset"
}
$ns at 0.5 "$ns trace-annotate \"Starting FTP0 node5 to node6\"" 
$ns at 0.5 "$ns trace-annotate \"Starting FTP1 node7 to node9\"" 
