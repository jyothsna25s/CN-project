...
set tracefile [open vegas1.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open vegas1.nam w]
...
#Setup a CBR Application over TCP/Vegas connection
...
set vegas1 [open "Vegas1.plot" w]
$ns at 0.0 "plotWindow $tcp0 $vegas1"
