...
##it drop the packets at that time of queue is full it not accept other packets thats called drop tail queue. CMU priqueue used to transmit the routing protocol packet at priority manner thats called the CMU priqueue
