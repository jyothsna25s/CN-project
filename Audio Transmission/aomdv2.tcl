...
#plot "resEnAodv1" w lp, "resEnAomdv1" w lp ,"resEnDsr1" w lp,"resEnDsdv1" w lp
#plot "insthrAodv1" w lp , "insthrAomdv1" w lp, "insthrDsr1" w lp ,"insthrDsdv1" w lp
...
set tracefile [open Aomdv2.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open Aomdv2.nam w]
