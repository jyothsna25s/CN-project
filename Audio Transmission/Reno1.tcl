...
set tracefile [open reno1.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open reno1.nam w]
...
#Setup a CBR Application over TCP/Reno connection
...
set reno1 [open "Reno1.plot" w]
$ns at 0.0 "plotWindow $tcp0 $reno1"
