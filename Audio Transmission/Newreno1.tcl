...
set tracefile [open newreno1.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open newreno1.nam w]
...
#Setup a CBR Application over TCP/Newreno connection
...
set newreno1 [open "Newreno1.plot" w]
$ns at 0.0 "plotWindow $tcp0 $newreno1"
