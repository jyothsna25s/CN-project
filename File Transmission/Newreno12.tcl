...
set tracefile [open newreno12.tr w]
$ns trace-all $tracefile
$ns use-newtrace
#Open the NAM trace file
set namfile [open newreno12.nam w]
...
set newreno12 [open "Newreno12.plot" w]
$ns at 0.0 "plotWindow $tcp0 $newreno12"
